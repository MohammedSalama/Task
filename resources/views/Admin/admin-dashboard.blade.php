              ...
              <div class="d-block d-md-flex justify-content-between">
                ...
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade active show" id="months" role="tabpanel" aria-labelledby="months-tab">
                    <div class="row mb-30">
                       <div class="col-md-2 col-sm-6">
                         <img class="img-fluid" src="{{ URL::asset('assets/images/blog/05.jpg') }}" alt="">
                       </div>
                      ...
                      <div class="row mb-30">
                       <div class="col-md-2 col-sm-6">
                         <img class="img-fluid" src="{{ URL::asset('assets/images/blog/02.jpg') }}" alt="">
                       </div>
                       <div class="col-md-6 col-sm-6">
                      ...
                      <div class="row mb-30">
                       <div class="col-md-2 col-sm-6">
                         <img class="img-fluid" src="{{ URL::asset('assets/images/blog/03.jpg') }}" alt="">
                       </div>
                       <div class="col-md-6 col-sm-6">
                      ...
                      <div class="row">
                       <div class="col-md-2 col-sm-6">
                         <img class="img-fluid" src="{{ URL::asset('assets/images/blog/04.jpg') }}" alt="">
                       </div>
                       <div class="col-md-6 col-sm-6">
                  ...
                  <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                    <div class="row mb-30">
                       <div class="col-md-2 col-sm-6">
                         <img class="img-fluid" src="{{ URL::asset('assets/images/blog/09.jpg') }}" alt="">
                       </div>
                       <div class="col-md-6 col-sm-6">
                    ...
                    <div class="row mb-30">
                       <div class="col-md-2 col-sm-6">
                         <img class="img-fluid" src="{{ URL::asset('assets/images/blog/06.jpg') }}" alt="">
                       </div>
                       <div class="col-md-6 col-sm-6">
                      ...
                      <div class="row mb-30">
                       <div class="col-md-2 col-sm-6">
                         <img class="img-fluid" src="{{ URL::asset('assets/images/blog/07.jpg') }}" alt="">
                       </div>
                       <div class="col-md-6 col-sm-6">
                      ...
                      <div class="row">
                       <div class="col-md-2 col-sm-6">
                         <img class="img-fluid" src="{{ URL::asset('assets/images/blog/08.jpg') }}" alt="">
                       </div>
                       <div class="col-md-6 col-sm-6">
 ...
 <div class="row">
   <div class="col-xl-4 mb-30">
    ...
    <div class="col-xl-4 mb-30">
     ...
     <div class="col-xl-4 mb-30">
      <div class="card card-statistics h-100">
        <div class="p-4 text-center bg" style="background: url(assets/images/bg/01.jpg);">
